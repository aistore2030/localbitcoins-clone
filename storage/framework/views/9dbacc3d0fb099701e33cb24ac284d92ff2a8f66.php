...
<?php endif; ?>
     ...
     <h1>Contact #<?php echo e($po->id); ?>: Sell  <?php echo e($po->btcvalue); ?> BTC for <?php echo e($po->c1value); ?>   <?php echo e($po->currency); ?> </h1> 

<h3>Sell in advertisement #<?php echo e($po->trade_id); ?> (Other online payment) to <?php echo e($po->trade->username); ?> at the exchange rate <?php echo e($po->rate); ?> <?php echo e($po->currency); ?> .</h3> 
...
<?php echo $__env->make('design1layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xpagg/public_html/resources/views/Localbitcoins/process_trade_sell.blade.php ENDPATH**/ ?>