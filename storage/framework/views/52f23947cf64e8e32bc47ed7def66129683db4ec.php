...
<?php endif; ?>
     ...
     <h1>Contact #<?php echo e($po->id); ?>: Selling <?php echo e($po->btcvalue); ?> BTC for <?php echo e($po->c1value); ?> BRS </h1> 

<h3>Selling in advertisement #<?php echo e($po->trade_id); ?> (Other online payment) to <?php echo e($po->trade->username); ?> at the exchange rate  	30,642.55 BRL .</h3> 
...
<?php echo $__env->make('design1layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xpagg/public_html/resources/views/Localbitcoins/process_trade.blade.php ENDPATH**/ ?>